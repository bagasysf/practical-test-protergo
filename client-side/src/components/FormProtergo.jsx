...
export default function FormProtergo({ textButton, headerForm, navButton }) {
        ...
        >
          ...
          <div className="flex flex-col justify-between gap-[20px] py-[10px]">
            ...
            <div className="flex flex-col">
              {navButton === 'Login' ? (
                <span className="pb-[10px] text-center text-xs text-gray-500">
              ...
              <Button
                ...
                className="w-full bg-sky-400 hover:bg-sky-600"
              >
                {navButton}
              </Button>
            </div>
